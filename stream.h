...
struct RealStreamReqParam
{
    ...
    std::tuple<const ::std::string&, const ::std::string&, const ::std::string&, const int&, const int&, const int&, const ::std::string&> ice_tuple() const
    {
        return std::tie(id, callid, destip, destport, ssrc, pt, sdk);
    }
};
...
public:
    ...
    virtual void closeStreamAsync(::std::string callid, ::std::string id, ::std::function<void()> response, ::std::function<void(::std::exception_ptr)> exception, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
...
public:
    ...
    void closeStream(const ::std::string& callid, const ::std::string& id, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        _makePromiseOutgoing<void>(true, this, &StreamPrx::_iceI_closeStream, callid, id, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto closeStreamAsync(const ::std::string& callid, const ::std::string& id, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<void>>().get_future())
    {
        return _makePromiseOutgoing<void, P>(false, this, &StreamPrx::_iceI_closeStream, callid, id, context);
    }

    ::std::function<void()>
    closeStreamAsync(const ::std::string& callid, const ::std::string& id,
                     ::std::function<void()> response,
                     ::std::function<void(::std::exception_ptr)> ex = nullptr,
                     ::std::function<void(bool)> sent = nullptr,
                     const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &StreamPrx::_iceI_closeStream, callid, id, context);
    }
...
struct StreamReader<::Media::RealStreamReqParam, S>
{
    ...
    {
        istr->readAll(v.id, v.callid, v.destip, v.destport, v.ssrc, v.pt, v.sdk);
    }
};
...
public:
    ...
    void closeStream(const ::std::string& callid, const ::std::string& id, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_closeStream(_iceI_begin_closeStream(callid, id, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_closeStream(const ::std::string& callid, const ::std::string& id, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_closeStream(callid, id, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_closeStream(const ::std::string& callid, const ::std::string& id, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_closeStream(callid, id, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_closeStream(const ::std::string& callid, const ::std::string& id, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_closeStream(callid, id, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_closeStream(const ::std::string& callid, const ::std::string& id, const ::Media::Callback_Stream_closeStreamPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_closeStream(callid, id, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_closeStream(const ::std::string& callid, const ::std::string& id, const ::Ice::Context& context, const ::Media::Callback_Stream_closeStreamPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_closeStream(callid, id, context, cb, cookie);
    }
...
public:
    ...
    virtual void closeStream_async(const ::Media::AMD_Stream_closeStreamPtr& cb, const ::std::string& callid, const ::std::string& id, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_closeStream(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
