...
public:
	...
	MediaStream(const dt::OpenRealStreamParam & req, std::shared_ptr<CallBack> cb, //std::function<void(bool, const::Media::RealStreamRespParam&)> iceCB, 
	            /*std::function<void(::std::exception_ptr)> ecb,*/ std::shared_ptr<CamaraController> con);
...
public:
	...
	RealSteam(const dt::OpenRealStreamParam & req , std::shared_ptr<CallBack> cb,//const std::string &id, const std::string &destIp_, int destPort,
